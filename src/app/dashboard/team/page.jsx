...
import { faMagnifyingGlass, faPlus, faChevronLeft, faChevronRight} from "@fortawesome/free-solid-svg-icons";
...
const Team = () => {
  ...
  return (
    <main className="container w-full mx-auto flex flex-col">
       ...
       {/* tab content header */}
       <div
          className="w-[90%] mx-auto mt-24 flex flex-row justify-between items-center p-4 border border-[#ddd] shadow"
          role="search"
      ...
      <section className={`w-[90%] min-h-[70vh] mx-auto p-6 rounded-md shadow border 
        flex flex-row flex-wrap gap-4 justify-center lg:justify-start
        border-[#ddd] transition-all duration-300 ease-in-out my-8 `}>
        {
          current_data.map((item, index) => <TeamCard key={index}
