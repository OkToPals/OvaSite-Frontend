...
const Uses = () => {
  ...
  <div className="container flex flex-wrap px-5 py-24 mx-auto items-center">
    <div className="md:w-1/2 md:pr-12 md:py-8 md:border-r md:border-b-0 mb-10 md:mb-0 pb-10 border-b border-[#001233]">
      ...
      <a className="text-[#001233] inline-flex items-center mt-4 font-bold">Learn More
    ...
    <div className="flex flex-col md:w-1/2 md:pl-12">
      ...
      <nav className="flex flex-wrap list-none -mb-1">
       <li className="lg:w-1/3 mb-1 w-1/2">
          <a className="text-[#001233] hover:text-[#001233]">The Government</a>
        </li><br/><br/>
        <li className="lg:w-1/3 mb-1 w-1/2">
          <a className="text-[#001233]  hover:text-gray-800">Students</a>
        </li><br/>
        <li className="lg:w-1/3 mb-1 w-1/2">
          <a className="text-[#001233] hover:text-gray-800"></a>
        </li><br/>
        <li className="lg:w-1/3 mb-1 w-1/2">
          <a className="text-[#001233] hover:text-gray-800">NGOs</a>
        </li><br/>
        <li className="lg:w-1/3 mb-1 w-1/2">
          <a className="text-[#001233]  hover:text-gray-800">Research institutions and individual researchers</a>
        </li><br/>
        <li className="lg:w-1/3 mb-1 w-1/2">
          <a className="text-[#001233] hover:text-gray-800"></a>
        </li><br/>
        <li className="lg:w-1/3 mb-1 w-1/2">
          <a className="text-[#001233] hover:text-gray-800">Customer-centric Organizations</a>
        </li><br/>
        <li className="lg:w-1/3 mb-1 w-1/2">
          <a className="text-[#001233] hover:text-gray-800"></a>
        </li>
