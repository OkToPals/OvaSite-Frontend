...
export const Footer = () => {
  return (
<footer class="bg-white dark:bg-[#001233]">
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4">
            ...
            <div>
                ...
                <div class="flex flex-col items-start mt-5 space-y-2">
                    ...
                    <a href="#" class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">Development Team</a>
                    <a href="#" class="text-gray-600 transition-colors duration-300 dark:text-gray-300 dark:hover:text-blue-400 hover:underline hover:text-blue-500">Pricing</a>
                </div>
            </div>
